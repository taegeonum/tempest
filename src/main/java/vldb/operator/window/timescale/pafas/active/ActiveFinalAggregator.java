 ...
 */
public final class ActiveFinalAggregator<V> implements FinalAggregator<V> {
  private static final Logger LOG = Logger.getLogger(ActiveFinalAggregator.class.getName());
   ...
   */
  @Inject
  private ActiveFinalAggregator(final SpanTracker<V> spanTracker,
