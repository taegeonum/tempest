 ...
 */
public final class AdjustPartialOptimizedDependencyGraphForVldb2018<T> implements DependencyGraph {

  private static final Logger LOG = Logger.getLogger(AdjustPartialOptimizedDependencyGraphForVldb2018.class.getName());
   ...
   */
  @Inject
  private AdjustPartialOptimizedDependencyGraphForVldb2018(final TimescaleParser tsParser,
