 ...
 */
public final class RandomSelectionDependencyGraphImpl<T> implements DependencyGraph {

  private static final Logger LOG = Logger.getLogger(RandomSelectionDependencyGraphImpl.class.getName());
