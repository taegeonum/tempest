 ...
 */
public final class DefaultActiveFinalAggregatorImpl<V> implements ActiveFinalAggregator<V> {
  private static final Logger LOG = Logger.getLogger(DefaultActiveFinalAggregatorImpl.class.getName());
   ...
   */
  @Inject
  private DefaultActiveFinalAggregatorImpl(final SpanTracker<V> spanTracker,
