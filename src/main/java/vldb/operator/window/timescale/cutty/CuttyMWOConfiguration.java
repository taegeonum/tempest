 ...
 */
public final class CuttyMWOConfiguration extends TimescaleWindowBaseConfiguration {

    public static final ConfigurationModule CONF = new CuttyMWOConfiguration()
        .merge(TimescaleWindowBaseConfiguration.CONF)
        .bindImplementation(TimescaleWindowOperator.class, CuttyMWO.class)
