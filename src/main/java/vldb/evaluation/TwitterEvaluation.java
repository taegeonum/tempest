...
public final class TwitterEvaluation {
  ...
  public static void main(final String[] args) throws Exception {
    ...
    || operatorType == TestRunner.OperatorType.FastRb2)
    ...
    } else if (operatorType == TestRunner.OperatorType.FastRbNum || operatorType == TestRunner.OperatorType.FastPruning) {
...
*/
    ...
    */
    ...
    } else if (operatorType == TestRunner.OperatorType.FastWeight ||operatorType == TestRunner.OperatorType.FastRandom ) {
      if (overlapRatio > 0.0) {
        writer.writeLine(prefix + "_result", overlapRatio + "\t" + metrics);
      } else {
