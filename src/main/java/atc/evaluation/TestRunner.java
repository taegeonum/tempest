...
import atc.evaluation.common.FileWordGenerator;
import atc.evaluation.common.Generator;
import atc.evaluation.common.ZipfianGenerator;
import atc.evaluation.parameter.EndTime;
import atc.evaluation.util.Profiler;
...
import atc.operator.window.timescale.*;
import atc.operator.window.timescale.common.DefaultOutputLookupTableImpl;
import atc.operator.window.timescale.common.TimescaleParser;
import atc.operator.window.timescale.naive.NaiveMWOConfiguration;
import atc.operator.window.timescale.onthefly.OntheflyMWOConfiguration;
import atc.operator.window.timescale.pafas.*;
...
import atc.operator.window.timescale.triops.TriOpsMWOConfiguration;
