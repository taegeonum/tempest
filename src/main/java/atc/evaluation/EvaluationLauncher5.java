...
import atc.evaluation.util.EvaluationUtils;
import atc.evaluation.util.ProcessHelper;
import atc.evaluation.util.StreamGobbler;
 ...
 */
public final class EvaluationLauncher5 {
  private static final Logger LOG = Logger.getLogger(EvaluationLauncher5.class.getName());
  ...
  static final String outputPath = "./log/0429-wordcount/num-windows-large2";
  ...
  public static void main(final String[] args) throws Exception {
    ...
    final List<Integer> numWindows = Arrays.asList(/*50, */50);
