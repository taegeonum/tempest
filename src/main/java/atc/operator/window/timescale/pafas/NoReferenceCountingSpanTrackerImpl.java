 ...
 */
public final class NoReferenceCountingSpanTrackerImpl<I, T> implements SpanTracker<T> {
  private static final Logger LOG = Logger.getLogger(NoReferenceCountingSpanTrackerImpl.class.getName());
   ...
   */
  @Inject
  private NoReferenceCountingSpanTrackerImpl(final TimescaleParser tsParser,
