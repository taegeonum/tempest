...
import atc.operator.window.timescale.common.LongComparator;
 ...
 */
public final class DynamicGreedyOutputLookupTableImpl<V> implements DynamicOutputLookupTable<V> {
  private static final Logger LOG = Logger.getLogger(DynamicGreedyOutputLookupTableImpl.class.getName());
