 ...
 */
public final class DependencyGraphSpanTracker<I, T> implements SpanTracker<T> {
  private static final Logger LOG = Logger.getLogger(DependencyGraphSpanTracker.class.getName());
   ...
   */
  @Inject
  private DependencyGraphSpanTracker(final TimescaleParser tsParser,
