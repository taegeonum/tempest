 ...
 */
final class AvgTestBolt extends BaseRichBolt {
  /**
   * WordCount bolt using MTSOperator.
   */
  private static final long serialVersionUID = 1298716785871980572L;
  private static final Logger LOG = Logger.getLogger(AvgTestBolt.class.getName());
   ...
   * Window Operator.
   */
  private TimescaleWindowOperator<Tuple, Map<String, SumAndCount>> operator;
   ...
   */
  public AvgTestBolt(final String pathPrefix,
  ...
  public void prepare(final Map conf, final TopologyContext paramTopologyContext,
    ...
    final MTSOperatorProvider<Tuple, Map<String, SumAndCount>> operatorProvider =
    ...
    try {
      final TimeWindowOutputHandler<Map<String, SumAndCount>, Map<String, Long>>
          handler = ij.getInstance(AvgOutputLogger.class);
