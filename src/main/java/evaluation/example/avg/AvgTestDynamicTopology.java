 ...
 */
final class AvgTestDynamicTopology {
  private static final Logger LOG = Logger.getLogger(AvgTestDynamicTopology.class.getName());

  private AvgTestDynamicTopology() {
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    final BaseRichBolt bolt = new AvgTestDynamicBolt(
        logDir + testName,
        timescales,
