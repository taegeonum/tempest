...
import atc.evaluation.common.RandomWordSpout;
 ...
 */
final class MTSWordCountTestDynamicTopology {
  private static final Logger LOG = Logger.getLogger(MTSWordCountTestDynamicTopology.class.getName());

  private MTSWordCountTestDynamicTopology() {
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    final BaseRichBolt bolt = new MTSWordCountTestDynamicBolt(
        logDir + testName,
        timescales,
