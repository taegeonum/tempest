 ...
 */
final class LinregTestDynamicTopology {
  private static final Logger LOG = Logger.getLogger(LinregTestDynamicTopology.class.getName());

  private LinregTestDynamicTopology() {
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    final BaseRichBolt bolt = new LinregTestDynamicBolt(
        logDir + testName,
        timescales,
