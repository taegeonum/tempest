 ...
 */
final class LinregTestBolt extends BaseRichBolt {
  /**
   * WordCount bolt using MTSOperator.
   */
  private static final long serialVersionUID = 1298716785871980572L;
  private static final Logger LOG = Logger.getLogger(LinregTestBolt.class.getName());
   ...
   * Window Operator.
   */
  private TimescaleWindowOperator<Tuple, Map<String, LinregVal>> operator;
   ...
   */
  public LinregTestBolt(final String pathPrefix,
  ...
  public void prepare(final Map conf, final TopologyContext paramTopologyContext,
    ...
    final MTSOperatorProvider<Tuple, Map<String, LinregVal>> operatorProvider =
