...
import vldb.operator.window.timescale.pafas.vldb2018.InterNodeDependencyGraph;
import vldb.operator.window.timescale.pafas.vldb2018.InterNodeMWOConfiguration;
...
public final class PafasMWOTest {
  ...
  public void testPafasMWO() throws Exception {
    ...
    final String timescaleString6 = "(5,1)(10,1)(20,2)(30,2)(60,4)(90,4)(360,5)(600,5)(900,10)(1800,10)";
    final String timescaleString = "(5,2)(6,2)(10,2)";
    final String timescaleString2 = "(107,60)(170,1)(935,10)(1229,10)(1991,110)(2206,20)(2284,140)(2752,30)(2954,88)(2961,165)(2999,60)(3043,55)(3076,35)(3134,110)(3161,210)(3406,40)(3515,385)(3555,40)(3590,210)(3593,840)";
    ...
    final String timescaleString1 = "(5,2)(8,3)(15,2)";
    ...
    // PAFAS
    final String timescaleString5 =  "(4,1)(5,1)(6,1)(10,1)";
