...
import vldb.operator.window.timescale.pafas.vldb2018.FlatFitConvergingDPSelectionAlgorithm;
import vldb.operator.window.timescale.pafas.vldb2018.FlatFitConvergingDependencyGraph;
...
public final class PafasMWOTest {
  ...
  public void testPafasMWO() throws Exception {
    ...
    //final String timescaleString =  "(5,4)(8,3)(12,7)(16,6)(21,8)";
    ...
    final String timescaleString = "(5,1)(14,2)";
...
*/
    ...
    configurationList.add(FlatFitCombinedMWOConfiguration.CONF
        ...
        .set(FlatFitCombinedMWOConfiguration.SELECTION_ALGORITHM, FlatFitConvergingDPSelectionAlgorithm.class)
        .set(FlatFitCombinedMWOConfiguration.OUTPUT_LOOKUP_TABLE, DPOutputLookupTableImpl.class)
        .set(FlatFitCombinedMWOConfiguration.DEPENDENCY_GRAPH, FlatFitConvergingDependencyGraph.class)
