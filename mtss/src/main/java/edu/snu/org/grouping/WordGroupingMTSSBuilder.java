...
public class WordGroupingMTSSBuilder implements AppTopologyBuilder {

  private final StormTopology topology;
  
  @Inject
  public WordGroupingMTSSBuilder(BaseRichSpout spout,
      WordGroupingMTSSWindowBolt wcBolt,
    ...
    String counterId = "HistogramMTSSOperator";
    ...
    for (Timescale ts : timescales) {
      ...
      WordGroupingMergeBolt bolt = ij.getInstance(WordGroupingMergeBolt.class);
