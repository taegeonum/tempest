 ...
 * under the License.
 */
package edu.snu.tempest.util.test;
...
/**
 * Test caasc aggregator.
 */
public final class TestAggregator implements ComAndAscAggregator<Integer, Map<Integer, Integer>> {
  ...
  @Override
  public Map<Integer, Integer> finalAggregate(final Collection<Map<Integer, Integer>> partials) {
