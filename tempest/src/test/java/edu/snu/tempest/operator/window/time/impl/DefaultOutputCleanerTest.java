...
public final class DefaultOutputCleanerTest {
  ...
  public void onTimescaleAdditionTest() {
    ...
    final DefaultOutputCleaner outputCleaner = new DefaultOutputCleaner(timescales, table, 0);
    ...
    outputCleaner.onTimescaleAddition(new Timescale(5, 1), 5L);
  ...
  public void onTimescaleDeletionTest() {
    ...
    // delete timescale
    outputCleaner.onTimescaleDeletion(t2, 13L);
