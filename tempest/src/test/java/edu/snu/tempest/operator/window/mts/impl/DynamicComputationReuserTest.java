...
public class DynamicComputationReuserTest {

  /**
   * test final aggregation.
   */
  @Test
  public void computationReuserTest() {
    ...
    final ComputationReuser<Map<Integer, Long>> computationReuser =
        new DynamicComputationReuser<>(timescales, aggregator, new CachingRatePolicy(timescales, 1), startTime);
