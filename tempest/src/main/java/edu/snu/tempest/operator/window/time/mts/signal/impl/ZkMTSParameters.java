...
import edu.snu.tempest.operator.window.time.mts.signal.TimescaleSignal;
import edu.snu.tempest.operator.window.time.mts.signal.TimescaleSignalDecoder;
import edu.snu.tempest.operator.window.time.mts.signal.TimescaleSignalEncoder;
