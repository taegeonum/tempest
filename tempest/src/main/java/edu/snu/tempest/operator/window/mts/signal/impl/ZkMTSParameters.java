...
import edu.snu.tempest.operator.window.mts.signal.TimescaleSignal;
import edu.snu.tempest.operator.window.mts.signal.TimescaleSignalDecoder;
import edu.snu.tempest.operator.window.mts.signal.TimescaleSignalEncoder;
